            ...
            <div className="flex flex-col flex-grow pt-5 overflow-y-auto border-r bg-neutral-800 ">
                <div className="flex flex-col items-center flex-shrink-0 px-4 ">
                    <Link className="px-8 text-left focus:outline-none" href="/dashboard">
                        <h2 className="block p-2 text-xl font-medium tracking-tighter transition duration-500 ease-in-out transform cursor-pointer text-white hover:text-white">Dashboard</h2>
                    </Link>
                ...
                <div className="flex flex-col flex-grow px-4 mt-5 ">
                    <nav className="flex-1 space-y-1 bg-neutral-800">
                        <ul>
                            <li>
                                <Link className="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform border rounded-lg text-white border-neutral-800 hover:border-neutral-800 focus:shadow-outline hover:bg-neutral-900" white="" href="/dashboard">
                            ...
                            <li>
                                <Link className="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform border rounded-lg text-white border-neutral-800 hover:border-neutral-800 focus:shadow-outline hover:bg-neutral-900" href="/dashboard/upload">
                            ...
                            <li>
                                <Link className="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform border rounded-lg text-white border-neutral-800 hover:border-neutral-800 focus:shadow-outline hover:bg-neutral-900" href="/dashboard/status">
                                    ...
                                    <span className="ml-4">All Records</span>
                                </Link>
                            </li>
                            {/* <li>
                        ...
                        <p className="px-4 pt-4 font-medium uppercase text-white ">Recent Five</p>
                        <ul>
                            {nums.map(item => {
                                let path = `/dashboard/audio/${item}`
                                return (
                                    <li key={item}>
                                    <Link className="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform border rounded-lg text-white border-neutral-800 hover:border-neutral-800 focus:shadow-outline hover:bg-neutral-900" white="" href={path}>
                                        <svg data-slot="icon" className="w-4 h-4" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
